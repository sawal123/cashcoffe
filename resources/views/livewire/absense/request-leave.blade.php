<main class="max-w-[1280px] mx-auto px-4 md:px-8 py-6">
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-outline-variant/30">
                                    ...
                                    <td class="px-6 py-5 text-center">
                                        <div class="flex items-center justify-center gap-1">
                                            ...
                                            @if($req->status === 'pending')
                                                <button type="button" wire:click="editRequest({{ $req->id }})"
                                                    title="Edit"
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="text-center py-20 font-body-md text-secondary">Belum ada riwayat pengajuan.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
    ...
    {{-- Modal Form Pengajuan (menggunakan $wire.entangle) --}}
    <div
            ...
            <div class="p-6">
                <form wire:submit.prevent="submit" class="space-y-5">
                    ...
                    @if($this->total_hari > 0)
                        <div class="p-3 {{ $this->is_quota_exceeded ? 'bg-error/10 border-error/20' : 'bg-primary/5 border-primary/10' }} rounded-lg flex items-center justify-between transition-colors border">
    ...
    {{-- Modal Detail Pengajuan (menggunakan $wire.entangle) --}}
    <div
