<div>
    ...
    <div class="overflow-x-auto border border-neutral-200 dark:border-neutral-700 rounded-2xl">
        <table class="w-full text-left text-sm text-neutral-600 dark:text-neutral-400">
            <thead
                class="bg-neutral-50 dark:bg-neutral-800/50 text-neutral-800 dark:text-neutral-200 uppercase text-xs font-bold border-b border-neutral-200 dark:border-neutral-700">
                <tr>
            ...
            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                ...
                @empty
                    <tr>
                        <td colspan="5" class="px-6 py-8 text-center text-neutral-500">Belum ada cabang terdaftar.
                        </td>
                    </tr>
                @endforelse
            </tbody>
