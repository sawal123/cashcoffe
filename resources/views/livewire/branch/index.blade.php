        ...
        <table class="w-full text-left text-sm text-neutral-600 dark:text-neutral-400">
            ...
            <tbody class="divide-y divide-neutral-200 dark:divide-neutral-700">
                ...
                <tr class="hover:bg-neutral-50 dark:hover:bg-neutral-800/50 transition-colors">
                    ...
                    <td class="px-6 py-4">
                        <span class="px-3 py-1 bg-blue-50 text-blue-600 dark:bg-blue-900/30 dark:text-blue-400 rounded-lg font-bold text-xs uppercase tracking-wider">
                    ...
                    <td class="px-6 py-4 text-center">
                        <button wire:click="edit({{ $b->id }})" class="p-2 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20 rounded-xl transition-colors">
                ...
                @empty
                <tr>
                    <td colspan="5" class="px-6 py-8 text-center text-neutral-500">Belum ada cabang terdaftar.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
    ...
    <x-mdal name="modal-branch">
        <div class="p-6">
            ...
            <form wire:submit.prevent="{{ $isEdit ? 'update' : 'store' }}" class="space-y-4">
                ...
                <x-ui.input label="Nama Cabang" wire:model="nama_cabang" placeholder="Misal: Cabang Sudirman" required />
                
                <div>
                    <label class="text-sm font-semibold text-neutral-600 dark:text-neutral-400 mb-2 block">Alamat (Opsional)</label>
                    <textarea wire:model="alamat" class="w-full bg-neutral-50 dark:bg-neutral-900 border-0 rounded-2xl px-4 py-3 placeholder:text-neutral-400 focus:ring-2 focus:ring-blue-500 text-neutral-800 dark:text-neutral-200" rows="3" placeholder="Alamat lengkap cabang"></textarea>
                </div>
