    ...
    <div id="pesan"
        ...
        <div x-data="{ openModal: null }"
            ...
            <div x-show="openModal !== null" style="display: none;"
                class="fixed inset-0 z-[999999] flex items-center justify-center bg-black/60 backdrop-blur-sm p-4 overflow-y-auto">
        ...
        @if (
            ...
            <div
                ...
                <button type="button" wire:click="hapusDiskon"
                    ...
                    <iconify-icon icon="mingcute:close-line" class="text-base"></iconify-icon>
                </button>
            </div>
        @endif
            ...
            <div class="pt-4 space-y-3">
                @if ($status !== 'dibatalkan' && $status !== 'selesai')
                    <button type="button" wire:click="{{ $submit }}" wire:loading.attr="disabled"
                        wire:target="{{ $submit }}"
                        class="w-full px-8 py-4 text-lg bg-blue-600 text-white rounded-2xl shadow-lg shadow-blue-500/30 font-bold transition-all active:scale-95 flex items-center justify-center gap-2"
                        ...
                        <span wire:loading.remove wire:target="{{ $submit }}">{{ $teks }} Pesanan</span>
