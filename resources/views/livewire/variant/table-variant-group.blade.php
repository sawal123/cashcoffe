<div>
    ...
    <div
        ...
        <div class="p-6 border-b border-neutral-100 dark:border-neutral-700 bg-neutral-50/50 dark:bg-neutral-800/50">
            ...
            <tbody class="divide-y divide-slate-200">
                @forelse ($groups as $group)
                    <tr class="hover:bg-slate-50 transition">
                        <td class="px-6 py-4 text-slate-800 font-medium">{{ $group->nama_group }}</td>
                        <td class="px-6 py-4">
                            <span
                        ...
                        <td class="px-6 py-4 text-slate-600">{{ $group->options_count }} Opsi</td>
