<div>
        ...
        <table class="table basic-border-table mb-2">
            <thead>
                <tr>
                    ...
                    <th class="border-r border-neutral-200 dark:border-neutral-600">HPP</th>
            ...
            <tbody>
                @forelse($items as $i)
                    <tr>
                        ...
                        <td class="border-r border-neutral-200 dark:border-neutral-600">
                            <a href="/stock-dapur/{{ base64_encode($i->id) }}/edit" wire:navigate
    ...
    <x-mdl>
        ...
        <div class="flex justify-center gap-3 border-t border-neutral-200 p-4 dark:border-neutral-700">
            ...
            <button x-on:click="$wire.deleteIngredient(selectedId); modalIsOpen = false"
