    ...
    <div class="space-y-4">
        ...
        <div class="grid md:grid-cols-3 gap-4">
            <div
                ...
                <h4 class="text-sm font-medium text-neutral-500 dark:text-neutral-400 mb-1">
                    Total Omset Bulan Ini
                </h4>
                <p class="text-lg font-semibold text-neutral-800 dark:text-white">
            ...
            <table class="table basic-border-table mb-2">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ number_format($item->total_komplemen, 0, ',', '.') }}</td>
