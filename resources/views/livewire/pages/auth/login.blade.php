...
<div class="login-panel">
    ...
    <form wire:submit="login" x-data="{ show: false }" class="login-form">
        <!-- Email Address -->
        <div class="login-field">
            ...
            <div class="login-input-wrap">
                ...
                <input wire:model="form.email" id="email" class="login-input" type="email" name="email" required
        ...
        <div class="login-field">
            ...
            <div class="login-input-wrap">
                ...
                <input wire:model="form.password" id="password" class="login-input login-input-password"
                    x-bind:type="show ? 'text' : 'password'" name="password" required autocomplete="current-password" />
                <button type="button" @click="show = !show" class="login-password-toggle"
                    :aria-label="show ? '{{ __('Hide password') }}' : '{{ __('Show password') }}'">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="login-icon"
                        x-show="!show">
        ...
        <div>
            <label for="remember" class="login-remember">
                <input wire:model="form.remember" id="remember" type="checkbox"
                    class="login-checkbox rounded border-gray-300 text-indigo-600 shadow-sm focus:ring-indigo-500"
                    name="remember">
        ...
        <div class="login-actions">
            <x-primary-button class="login-submit ms-3 w-full justify-center" wire:loading.attr="disabled">
