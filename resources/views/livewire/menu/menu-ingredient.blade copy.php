    ...
    <div class="card p-5 rounded-xl shadow border border-neutral-200 dark:border-neutral-700">
        ...
        <div class="grid grid-cols-12 gap-4">
            ...
            <div class="col-span-12 md:col-span-6">
                ...
                <input type="number" wire:model="qty" class="w-full rounded-lg border border-neutral-300 dark:border-neutral-600 
            ...
            <div class="col-span-12 md:col-span-2 flex md:items-end">
                <button wire:click="addIngredient" class="w-full rounded-lg py-2 h-[42px] bg-blue-600 hover:bg-blue-700 
            ...
            <table class="w-full border-collapse">
                <thead>
                    <tr class="bg-neutral-100 dark:bg-neutral-800 border-b border-neutral-200 dark:border-neutral-700">
                        ...
                        <th class="text-left px-3 py-2 font-semibold text-sm">HPP</th>
                        <th class="w-16"></th>
                    </tr>
                </thead>
                ...
                <tbody>
                    ...
                    <tr class="border-b border-neutral-200 dark:border-neutral-700">
                        ...
                        <td class="px-3 py-2 text-right">
                            <button wire:click="removeIngredient({{ $row->id }})" class="px-3 py-1.5 rounded-lg text-white bg-red-500 hover:bg-red-600 
                ...
                <tfoot>
                    <tr class="border-t-2 border-neutral-300 dark:border-neutral-600">
                        <td colspan="2" class="px-3 py-4 text-right font-bold text-gray-800 dark:text-gray-200">
                            Total HPP:
                        </td>
                        <td class="px-3 py-4 font-bold text-blue-600 dark:text-blue-400 text-lg">
                            Rp {{ number_format($this->total_hpp, 0, ',', '.') }}
                        </td>
                        <td class="px-3 py-4 text-right mt-1">
                            <button wire:click="saveHpp" class="px-4 py-2 rounded-lg text-white bg-green-500 hover:bg-green-600 
                                       text-sm font-bold shadow-md transition ml-auto block w-max">
                                Simpan HPP Menu
                            </button>
                        </td>
                    </tr>
