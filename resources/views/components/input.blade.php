...
<div class="mb-2 relative">
    ...
    <input type="{{ $type }}" placeholder="{{ $place }}" autocomplete="one-time-code" {{ $attributes->class([
    ...
    <div wire:loading wire:target="{{ $target }}" class="pointer-events-none absolute right-2 top-1/2 -translate-y-1/2">
